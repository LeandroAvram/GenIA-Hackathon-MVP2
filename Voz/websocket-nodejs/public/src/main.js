...
async function initAudio() {
    try {
        ...
        statusElement.textContent = "Micrófono listo. Haz clic para comenzar.";
...
async function initializeSession() {
    ...
    statusElement.textContent = "Inicializando sesión...";
    statusIndicator.style.background = "#ffa500";
    ...
    try {
        ...
        statusElement.textContent = "Sesión inicializada correctamente";
        statusIndicator.style.background = "#00ff88";
    } catch (error) {
        console.error("Failed to initialize session:", error);
        statusElement.textContent = "Error inicializando sesión";
        statusIndicator.style.background = "#ff4444";
    }
}
...
async function startStreaming() {
    ...
    try {
        ...
        statusIndicator.style.background = "#ff4444";
        statusIndicator.style.animation = "pulse-red 1s infinite";
...
function updateChatUI() {
    ...
    chat.history.forEach(item => {
        ...
        if (item.role) {
            ...
            avatar.textContent = roleLowerCase === 'user' ? '👤' : '🤖';
            ...
            bubble.textContent = item.message || "No content";
...
function showUserThinkingIndicator() {
    ...
    avatar.className = 'message-avatar';
    avatar.textContent = '👤';
    userThinkingIndicator.appendChild(avatar);
    ...
    bubble.appendChild(listeningText);
    ...
    messageContent.appendChild(bubble);
    userThinkingIndicator.appendChild(messageContent);
...
function showAssistantThinkingIndicator() {
    ...
    avatar.className = 'message-avatar';
    avatar.textContent = '🤖';
    assistantThinkingIndicator.appendChild(avatar);
    ...
    bubble.appendChild(dotContainer);
    messageContent.appendChild(bubble);
    assistantThinkingIndicator.appendChild(messageContent);
...
socket.on('streamComplete', () => {
    ...
    statusElement.textContent = "Asistente Virtual - Listo";
    statusIndicator.style.background = "#00ff88";
...
socket.on('connect', () => {
    statusElement.textContent = "Asistente Virtual - Conectado";
    statusIndicator.style.background = "#00ff88";
    statusIndicator.style.animation = "pulse 2s infinite";
...
socket.on('disconnect', () => {
    statusElement.textContent = "Asistente Virtual - Desconectado";
    statusIndicator.style.background = "#ff4444";
    statusIndicator.style.animation = "none";
    startButton.disabled = true;
    stopButton.disabled = true;
